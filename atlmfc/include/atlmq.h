...
{
protected:
	CSimpleArray<CMQPropertyRestriction, CSimpleArrayEqualHelperFalse<CMQPropertyRestriction> > m_propRestrictions;
...
public:
	...
	{
		int nIndex = m_propRestrictions.Add(res);
		if (nIndex < 0)
			return nIndex;
		cRes++;
