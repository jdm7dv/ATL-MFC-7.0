...
// Implementation
	...
	LONG_PTR m_lDefaultLBFetchSize;     // For fetching CLongBinary data of unknown len
	LONG_PTR m_lDefaultLBReallocSize;   // For fetching CLongBinary data of unknown len
...
private:
	...
	inline void GetFieldValueEx(short nIndex, StringType &strValue, short nFieldType)
	{
		...
		void* pvData = strValue.GetBufferSetLength(nLen);  //REVIEW
