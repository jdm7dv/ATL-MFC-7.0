...
enum AfxTraceFlags
{
	...
	// REVIEW: will using the following values cause problems tp end users?
	traceDumpContext = 3,	// traces from CDumpContext
	traceMemory = 5,		// generic non-kernel memory traces
	traceGdi = 6,			// generic graphics traces
	traceUser = 7,			// generic window problems
	traceKernel = 9,		// generic kernel traces
	traceHtml = 10,			// Html traces
	traceSocket = 11		// Socket traces
