	...
	DWORD dwNotificationType, LPVOID pvNotification)
{
    ...
    case SF_NOTIFY_EXTENSION_TRIGGER:
        dwRet  = OnExtensionTrigger(&callCtxt,
            (PHTTP_FILTER_EXTENSION_TRIGGER_INFO) pvNotification);
        break;
...
DWORD CHttpFilter::OnExtensionTrigger(CHttpFilterContext *, PHTTP_FILTER_EXTENSION_TRIGGER_INFO)
{
    return SF_STATUS_REQ_NEXT_NOTIFICATION;
}
