...
These files are compiled to form the Microsoft Foundation Classes 7.0
(MFC 7.0).  The library may be built in a number of configurations,
...
variants of MFC 7.0.  See section 2 for instructions on building
