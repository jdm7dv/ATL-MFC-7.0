...
#define MFCO70_DLL  "MFCO70D.DLL"
#else
#define MFC70_DLL   "MFC70UD.DLL"
#define MFCO70_DLL  "MFCO70UD.DLL"
#endif
#else
#ifndef _UNICODE
#define MFC70_DLL   "MFC70.DLL"
#define MFCO70_DLL  "MFCO70.DLL"
#else
#define MFC70_DLL   "MFC70U.DLL"
#define MFCO70_DLL  "MFCO70U.DLL"
#endif
#endif
...
BOOL WINAPI RawDllMain(HINSTANCE /*hInstance*/, DWORD dwReason, LPVOID)
{
	...
	else if (dwReason == DLL_PROCESS_DETACH)
	{
		...
		FreeLibrary(GetModuleHandleA(MFCO70_DLL));
