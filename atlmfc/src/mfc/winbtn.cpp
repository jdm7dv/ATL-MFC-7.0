...
void CBitmapButton::Dump(CDumpContext& dc) const
{
	...
	dc << "m_bitmap = " << (UINT_PTR)m_bitmap.m_hObject;
	dc << "\nm_bitmapSel = " << (UINT_PTR)m_bitmapSel.m_hObject;
	dc << "\nm_bitmapFocus = " << (UINT_PTR)m_bitmapFocus.m_hObject;
	dc << "\nm_bitmapDisabled = " << (UINT_PTR)m_bitmapDisabled.m_hObject;
