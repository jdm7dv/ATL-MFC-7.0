...
DWORD CPropertySection::GetCount()  //REVIEW:64-bit?
...
BOOL CPropertySection::WriteNameDictToStream(IStream* pIStream)
{
	...
	ULONG cProperties = (ULONG)m_NameDict.GetCount() + 1;  //REVIEW: 64-bit?
...
DWORD CPropertySet::GetCount()  //REVIEW: 64-bit?
...
BOOL CPropertySet::WriteToStream(IStream* pIStream)
{
	...
	m_PH.cSections = (DWORD)m_SectionList.GetCount();  //REVIEW: 64-bit?
