...
BOOL CToolBar::AddReplaceBitmap(HBITMAP hbmImageWell)
{
	...
	if (m_hbmImageWell == NULL)
	{
		...
		addBitmap.nID = (UINT)(UINT_PTR)hbmImageWell;  //REVIEW
	...
	else
	{
		...
		replaceBitmap.nIDOld = (UINT)(UINT_PTR)m_hbmImageWell;  //REVIEW
		replaceBitmap.hInstNew = NULL;
		replaceBitmap.nIDNew = (UINT)(UINT_PTR)hbmImageWell;  //REVIEW
